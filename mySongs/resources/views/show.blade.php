...
<body>
    <header>
        <div class="heart-container">
            <img src="assets/heart.svg" class="white-heart"> 
        </div>
    ...
    <main>
        ...
        <table>
            ...
            <tbody class="t-height">
                @foreach ($mysongs as $song)
                    <tr>
                        <td class="id">{{$song->id}}</td>
                        <td class="title"><img class="album-image" src="{{$song->Imagen}}"><div><p>{{$song->Titulo}}</p><span>{{$song->Autor}}</span></div></td>
